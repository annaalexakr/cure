...
// Allows steward of NFT to set any tokenURI they like.
...
abstract contract ERC721URIStorage is ERC721 {
    ...
    /**
     * @dev Updates `_tokenURI` to whatever the steward of the NFT likes.
     *
     * Requirements:
     *
     * - `tokenId` must exist, caller must be steward of NFT.
     */
